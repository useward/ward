...
function ResourceRow(
  ...
  return (
    ...
    >
      ...
      <span className={cn("text-[10px] w-10 flex-shrink-0", config.text)}>
      ...
      {resource.cached && (
        <span className="text-[9px] px-1 py-0.5 bg-teal-500/20 text-teal-400 rounded">
          cached
        </span>
      )}

      {resource.status === "error" && (
        <span className="text-[9px] px-1 py-0.5 bg-red-500/20 text-red-400 rounded">
          error
        </span>
      )}
