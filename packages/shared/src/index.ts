...
export const SESSION_ID_HEADER = "x-ward-session-id";
export const PROJECT_ID_HEADER = "x-ward-project-id";
export const ATTR_SESSION_ID = "ward.session.id";
export const ATTR_PROJECT_ID = "ward.project.id";
